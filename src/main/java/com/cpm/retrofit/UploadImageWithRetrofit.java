...
public class UploadImageWithRetrofit  {
    ...
    public UploadImageWithRetrofit(Context context, GODREJDatabase db, ProgressDialog pd, int from) {
        this.context = context;
        this.db = db;
        this.pd = pd;
...
//            Bitmap bitmap = null;
//            try {
//                bitmap = BitmapFactory.decodeFile(path + filename, o2);
//            } catch (OutOfMemoryError ex) {
//                bitmap = CommonFunctions.convertBitmap(path + filename);
//            }
//
